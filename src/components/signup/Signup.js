...
export default function Signup() {
      ...
      <View>
        ...
        <View style={tw`h-3/5 mt-24 w-11/12 ml-4 bg-gray-100 rounded`}>
          ...
          <View style={tw` items-center pt-6 `}>
            <Text style={tw`  text-gray-500 font-bold text-xs`} >Or Sign Up with credentials </Text>
          </View>
 ...
 <Text style={tw `pl-8 mt-4 text-black`}>I Agree With The <Text style={tw `text-yellow-300`}>Privacy Policy</Text></Text>
 </View>
        </View>
      </ImageBackground>
    </View>
