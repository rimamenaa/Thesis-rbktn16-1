  ...
  return (
    <SafeAreaView style={tailwind("h-full")}>
      <ScrollView>
        ...
        <View>
          <Text style={tailwind("text-4xl font-bold text-yellow-500 ml-6 mb-6")}>Why Join By-Cycle?</Text>
          <ScrollView horizontal={true}>
      <Box style={tailwind("ml-4")}
      rounded="lg"
      overflow="hidden"
      width="72"
      shadow={1}
    ...
    >
      ...
      <Stack p="4" space={3}>
        ...
        <Text fontWeight="400">
          By-Cycle is often faster than other ways of getting around. It's quick to grab a bike and convenient to drop it 
          off at any station when you're done.
        </Text>
    ...
    >
      ...
      <Stack p="4" space={3}>
        ...
        <Text fontWeight="400">
          Using By-Cycle can save you you a lot of money. Whith unlimited 45 minutes trips included in your membership.
          It pays for itself after few rides.
        </Text>
        <HStack alignItems="center" space={4} justifyContent="space-between">
          <HStack alignItems="center">
            <Text color="gray.500" fontWeight="400">
    ...
    >
      ...
      <Stack p="4" space={3}>
        ...
        <Text fontWeight="400">
          Whether you're using By-Cycle to commute to work or ride to meet friends. 
          We bet you'll get there with a smile in your face.
        </Text>
        <HStack alignItems="center" space={4} justifyContent="space-between">
          <HStack alignItems="center">
            <Text color="gray.500" fontWeight="400">
    ...
    >
      ...
      <Stack p="4" space={3}>
        ...
        <Text fontWeight="400">
          Getting places by pedal power is great exercice. Even biking short distances can lead to 
          positive health benefits, as reduced stress.
        </Text>
        <HStack alignItems="center" space={4} justifyContent="space-between">
          <HStack alignItems="center">
            <Text color="gray.500" fontWeight="400">
    ...
    >
      ...
      <Stack p="4" space={3}>
        ...
        <Text fontWeight="400">
          Riding a bike is great for the environment. Taking By-Cycle instead of a car for short trips
          helps improve air quality and reduce carbon emission.
        </Text>
        <HStack alignItems="center" space={4} justifyContent="space-between">
          <HStack alignItems="center">
            <Text color="gray.500" fontWeight="400">
