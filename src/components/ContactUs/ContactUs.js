...
function ContactUs() {
  return (
    <View style={tailwind("flex md:flex-row items-center h-full bg-gray-600 ")}>
      <View style={tailwind("  items-center w-80 ")}>
        ...
        <View style={tailwind("flex flex-row")}>
          <Text style={tailwind("font-bold text-white")}>info@by-cycle.tn</Text>
        </View>
        ...
        <View style={tailwind("flex flex-row")}>
          <Text style={tailwind("font-bold text-white")}>+216 11 222 333 </Text>
        </View>
        <View style={("greycard", tailwind("bg-#2F3945 h-96 "))}>
          <TextInput
            style={tailwind("h-28 w-80 ml-2 mt-14 bg-white")}
            type="text"
          ...
          />
          <TextInput
            style={tailwind("mt-6 h-80 w-80 ml-2 bg-white")}
            numberOfLines={4}
            type="text"
