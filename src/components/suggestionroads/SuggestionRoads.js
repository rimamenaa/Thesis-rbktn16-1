...
function SuggestionRoads() {
    ...
    >
      ...
      <Stack p="4" space={3}>
        <Stack space={2}>
          <Heading size="md" ml="-1">
          <Entypo name="location-pin" size={24} color="black" /> From Cité Olympique to Cité El Ghazela
          </Heading>
        </Stack>
        <Text fontWeight="400">
        <FontAwesome5 name="clock" size={24} color="black" /> Duration: 1:05h         <MaterialCommunityIcons name="map-marker-distance" size={24} color="black" />
Distance: 9km 
        </Text>
        <HStack alignItems="center" space={4} justifyContent="space-between">
    ...
    >
      ...
      <Stack  p="4" space={3}>
        ...
        <Text fontWeight="400">
        <FontAwesome5 name="clock" size={24} color="black" /> Duration: 1:18h         <MaterialCommunityIcons name="map-marker-distance" size={24} color="black" />
Distance: 11km 
        </Text>
        <HStack alignItems="center" space={4} justifyContent="space-between">
          <HStack alignItems="center">
    ...
    >
      ...
      <Stack  p="4" space={3}>
        <Stack space={2}>
          <Heading size="md" ml="-1">
          <Entypo name="location-pin" size={24} color="black" /> La Goulette, Tunis
          </Heading>
        </Stack>
        <Text fontWeight="400">
        <FontAwesome5 name="clock" size={24} color="black" /> Duration: 1:38h         <MaterialCommunityIcons name="map-marker-distance" size={24} color="black" />
Distance: 11km 
        </Text>
        <HStack alignItems="center" space={4} justifyContent="space-between">
          <HStack alignItems="center">
    ...
    >
      ...
      <Stack  p="4" space={3}>
        <Stack space={2}>
          <Heading size="md" ml="-1">
          <Entypo name="location-pin" size={24} color="black" /> Lac 3, Tunis
          </Heading>
        </Stack>
        <Text fontWeight="400">
...
Distance: 10.1km 
    ...
    >
      ...
      <Stack  p="4" space={3}>
        ...
        <Text fontWeight="400">
        <FontAwesome5 name="clock" size={24} color="black" /> Duration: 2:56h         <MaterialCommunityIcons name="map-marker-distance" size={24} color="black" />
Distance: 30km 
        </Text>
        <HStack alignItems="center" space={4} justifyContent="space-between">
          <HStack alignItems="center">
    ...
    >
      ...
      <Stack  p="4" space={3}>
        ...
        <Text fontWeight="400">
        <FontAwesome5 name="clock" size={24} color="black" /> Duration: 0:23h         <MaterialCommunityIcons name="map-marker-distance" size={24} color="black" />
Distance: 6km 
        </Text>
        <HStack alignItems="center" space={4} justifyContent="space-between">
