                  ...
                  <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    >
                      ...
                      {tabName === "Description" ? (
                        ...
                        >
                          La Perle du Lac, an illustration of the impeccable
                          aesthetic reintegration of water bodies into the urban
                          zone, is an exceptional area composed of judiciously
                          and coherently arranged residences that value space
                          harmony. The city, which will be built on 230 hectares
                          outspreads from the Berges du Lac to Tunis city center
                          as its direct extension, meets the designers’
                          ambitions to make it a large metropolis giving Tunis a
                          new face mirrored in water.
                        </Text>
                      ) : (
                        reviews.map((item, idx) => {
                          return (
